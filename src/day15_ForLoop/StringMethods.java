...
public class StringMethods {
    ...
    public static void main(String[] args) {
       ...
       boolean r3 = sentence.contains("java") || sentence.contains("Java"); // jAvA
        ...
        //booleans z  = a.toLowerCase().startsWith("wooden");
        // in order to ignore the case sensitivity we first create the lower case  of upper case version of string and then compare lower case to upper case
