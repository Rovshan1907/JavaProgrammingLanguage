...
public class UniqueElements {
    ...
    public static void main(String[] args) {
        int[] array = {1,1,2,3,3,4,5,5,6,7,7,7}; // if we will add there also 2 time each result elements we will have there empty
    ...
    public static int[] uniqueElements(int[] array){
        ...
        for (int each : array) {
            if (ArraysUtility.frequencyOfElement(array,each) == 1){ // if the freuqenyc is one,  the elemnt is unique
